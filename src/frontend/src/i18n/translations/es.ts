...
export const es: Translations = {
  ...
  showFoodMenu: 'Ver Menú',
  foodMenu: 'Menú',
  price: 'Precio',
  noMenuItems: 'Aún no hay menú',
  noMenuItemsDesc: 'Este vendedor aún no ha subido su menú.',
  menuLoadError: 'Error al cargar el menú',
  tryAgain: 'Reintentar',
  addFood: 'Añadir Plato',
  editMenu: 'Editar',
  done: 'Hecho',
  deleteMenuItem: 'Eliminar',
  deleteMenuItemConfirm: '¿Eliminar este plato?',
  menuTab: 'Menú',
  itemName: 'Nombre del Plato',
  itemPrice: 'Precio',
  itemDescription: 'Descripción',
  itemImage: 'URL de Imagen',
  noMenuItemsTab: 'No se encontraron menús',
