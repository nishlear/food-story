...
export const ja: Translations = {
  ...
  showFoodMenu: 'メニューを見る',
  foodMenu: 'メニュー',
  price: '価格',
  noMenuItems: 'まだメニューがありません',
  noMenuItemsDesc: 'このお店はまだメニューをアップロードしていません。',
  ...
  deleteMenuItem: '削除',
  deleteMenuItemConfirm: 'このメニューを削除しますか？',
  menuTab: 'メニュー',
  itemName: '商品名',
  itemPrice: '価格',
  itemDescription: '説明',
  itemImage: '画像URL',
  noMenuItemsTab: 'どの店舗にもメニューがありません',
