...
export const vi: Translations = {
  ...
  showFoodMenu: 'Xem Thực Đơn',
  foodMenu: 'Thực Đơn',
  price: 'Giá',
  noMenuItems: 'Chưa có thực đơn',
  noMenuItemsDesc: 'Quán chưa đăng tải thực đơn.',
  ...
  deleteMenuItem: 'Xóa',
  deleteMenuItemConfirm: 'Xóa món này?',
  menuTab: 'Thực Đơn',
  itemName: 'Tên Món',
  itemPrice: 'Giá',
  itemDescription: 'Mô Tả',
  itemImage: 'URL Hình Ảnh',
  noMenuItemsTab: 'Không có thực đơn nào',
