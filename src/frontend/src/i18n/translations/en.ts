...
export const en: Translations = {
  ...
  loginToRate: 'Log in to leave a review',
  loginToAddVendor: 'Log in to add vendors',
  loginTitle: 'Sign in to Food Story',
  orContinueAsGuest: 'Continue as Guest',
  ...
  showFoodMenu: 'Show Food Menu',
  foodMenu: 'Food Menu',
  price: 'Price',
  noMenuItems: 'No menu items yet',
  noMenuItemsDesc: "This vendor hasn't uploaded their menu yet.",
  ...
  deleteMenuItemConfirm: 'Delete this menu item?',
  menuTab: 'Menu',
  itemName: 'Item Name',
  itemPrice: 'Price',
  itemDescription: 'Description',
  itemImage: 'Image URL',
  noMenuItemsTab: 'No menu items found across any vendor',
